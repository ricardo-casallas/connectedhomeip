...
protected:
    ...
    virtual WindowApp::Timer * CreateTimer(const char * name, uint32_t timeoutInMs, WindowApp::Timer::Callback callback,
                                           void * context);
    virtual WindowApp::Button * CreateButton(WindowApp::Button::Id id, const char * name);
    virtual void ProcessEvents();
    virtual void DispatchEvent(const WindowApp::Event & event);
    void UpdateLEDs();
    void UpdateLCD();
